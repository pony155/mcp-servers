...
description: Author and review beat-'em-up combat timing, boxes, anchors, events, transitions, and readability. Use for attacks, grabs, throws, armor, invulnerability, hitstop, hitstun, knockback, cancels, and gameplay-facing visual clarity.
---
...
Review completed actions at gameplay scale for anticipation, reach, active-frame clarity, recovery, crowd overlap, and reaction legibility. Diagnose readability separately from balance: unclear silhouettes or mistimed effects are art-contract problems, while damage and cancel policy remain game-design inputs.
