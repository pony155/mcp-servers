...
description: Produce and validate player-character sprite sets for lane-based pixel-art beat-'em-ups in Aseprite. Use for movement, attacks, grabs, reactions, knockdowns, combat boxes, anchors, timing, and engine-ready manifests.
---
